...
TODO:
1. В Solution 'Pointers' добавить проект 'Split', и в этом проекте массив из 10 элементов,
...
2. Вынести код, добавляющий значение в конец массива в функцию ??? push_back(???);
