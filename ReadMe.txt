...
2. В Solution 'ConstrolStructures' добавить проект 'HomeWorkLoops',
   и в этом проекте решить следующие задачи:
    -возвести указанное число в указанную степень. Основание и показатель степени вводятся с клавиатуры;
	-вывести на экран таблицу ASCII-символов;
	-вывести на экран ряд Фибоначчи до указанного предела;
	-вывести на экран заданное количество членов из ряда Фибоначчи;
		Ряд Фибоначчи строится из двух чисел - 0 и 1,
		и каждый следующий член ряда = сумме двух предыдущих:
			0	1	1	2	3	5	8	13	21
	-вывести на экран ряд простых чисел до заданного предела.
